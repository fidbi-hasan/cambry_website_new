        ...
        <>
            ...
            <section className="py-6 bg-gradient-to-r from-amber-50 to-orange-50 border-y border-amber-100/60">
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-start gap-4">
                        <div className="w-10 h-10 bg-gradient-to-br from-amber-500 to-orange-500 rounded-md flex items-center justify-center flex-shrink-0 shadow-md">
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">How to Register for IELTS/PTE</h2>
                        </div>
                    </FadeIn>
                    <StaggerContainer className="grid grid-cols-1 md:grid-cols-4 gap-8">
                            ...
                            <StaggerItem key={item.step}>
                                <div className="text-center group">
                                    <div className={`w-16 h-16 rounded-lg bg-gradient-to-br ${item.gradient} text-white flex items-center justify-center mx-auto mb-5 text-xl font-bold shadow-lg group-hover:scale-110 transition-transform`}>
                                        {item.step}
                                    </div>
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">IELTS & PTE Exams + Courses</h2>
                        </div>
                    </FadeIn>
                    {ieltsItems.length > 0 ? (
                        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {ieltsItems.map((item: any) => (
                                <StaggerItem key={item.id}>
                                    <div className="bg-white border border-gray-100/60 rounded-xl overflow-hidden shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] transition-all duration-300 hover:-translate-y-1 group h-full flex flex-col">
                                        {item.imageUrl && (
                                        ...
                                        <div className="p-7 flex-1 flex flex-col">
                                            ...
                                            <div className="mt-5 pt-5 border-t border-gray-50">
                                                ...
                                                <a href={item.ctaUrl && (String(item.ctaUrl).startsWith("/") || String(item.ctaUrl).startsWith("#")) ? item.ctaUrl : "#enquiry"} className="inline-flex items-center gap-2 mt-4 px-4 py-2 rounded-md bg-gradient-to-r from-amber-500 to-orange-500 text-white text-xs font-bold">{item.ctaLabel || "Register Now"}<ArrowRight className="w-4 h-4" /></a>
                                            </div>
                                        </div>
                                    </div>
                                </StaggerItem>
                            ...
                            {[
                                ...
                                <StaggerItem key={item.type}>
                                    <div className="bg-white border border-gray-100/60 rounded-xl p-8 shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 group h-full">
                                        <div className={`w-14 h-14 bg-gradient-to-br ${item.gradient} rounded-lg flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform`}>
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Why Register Through Cambry?</h2>
                        </div>
                    </FadeIn>
                    <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-5 max-w-4xl mx-auto">
                        {[
                            ...
                            <StaggerItem key={item}>
                                <div className="flex items-center gap-4 p-5 bg-white border border-gray-100/60 rounded-lg shadow-[0_2px_16px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] hover:-translate-y-0.5 transition-all duration-300 group">
                                    <div className="w-10 h-10 bg-gradient-to-br from-emerald-500 to-teal-400 rounded-md flex items-center justify-center flex-shrink-0 shadow-md group-hover:scale-110 transition-transform">
            ...
            <section id="enquiry" className="py-28 bg-gradient-to-b from-slate-50 to-white relative">
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="bg-white/80 backdrop-blur-xl border border-gray-100/60 rounded-xl p-8 md:p-12 shadow-[0_20px_60px_rgba(0,0,0,0.06)] relative overflow-hidden">
