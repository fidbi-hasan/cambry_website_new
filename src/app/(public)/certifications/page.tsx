        ...
        <>
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Why Our Certifications Matter</h2>
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Certifications & Accreditations</h2>
                        </div>
                    </FadeIn>
                        ...
                        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {certifications.map((cert: any) => (
                                <StaggerItem key={cert.id}>
                                    <div className="bg-white border border-gray-100/60 rounded-xl overflow-hidden shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.1)] transition-all duration-300 group hover:-translate-y-1 h-full flex flex-col">
            ...
            <section className="py-28 bg-white relative overflow-hidden">
                ...
                <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
                    <FadeIn direction="up">
                        <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight mb-4">Work With a Certified Agency</h2>
