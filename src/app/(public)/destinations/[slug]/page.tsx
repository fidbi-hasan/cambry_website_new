                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                    <StaggerContainer className="grid grid-cols-2 lg:grid-cols-4 gap-6">
                        {[
                            ...
                            <StaggerItem key={s.label} className="text-center p-8 bg-white border border-gray-100/60 rounded-xl shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] transition-all duration-300 group">
                            ...
                            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                                <FadeIn direction="up">
                                    <div className="text-center mb-16">
                                        ...
                                        <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Why Study in {country.name}?</h2>
                                    </div>
                                </FadeIn>
                                <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                                    {infographic.whyStudy.map((reason: string, idx: number) => (
                                        <StaggerItem key={idx} className="bg-white p-8 rounded-xl border border-gray-100/60 shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] flex items-start gap-6 hover:-translate-y-1 transition-all duration-300 group">
                                            <div className="w-12 h-12 bg-gradient-to-br from-green-500 to-emerald-400 rounded-lg flex-shrink-0 flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform">
                            ...
                            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                                <FadeIn direction="up">
                                    <div className="text-center mb-16">
                                        ...
                                        <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Application Timeline</h2>
                                    </div>
                                </FadeIn>
                                        ...
                                        {infographic.timeline.map((item: any, idx: number) => (
                                            <FadeIn key={idx} direction={idx % 2 === 0 ? "right" : "left"} delay={idx * 0.1}>
                                                <div className={`relative flex items-center justify-between md:justify-normal ${idx % 2 === 0 ? "md:flex-row-reverse" : ""} group is-active`}>
                                                    ...
                                                    <div className="w-[calc(100%-3rem)] md:w-[calc(50%-2rem)] p-5 rounded-xl bg-white shadow-[0_2px_16px_rgba(0,0,0,0.04)] border border-gray-100/60 group-hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] transition-all duration-300 group-hover:-translate-y-1 relative overflow-hidden">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                                ...
                                {infographic.workRights && (
                                    <FadeIn direction="right">
                                        <div className="bg-white/[0.06] p-10 rounded-xl border border-white/[0.08] backdrop-blur-2xl hover:bg-white/[0.1] transition-colors duration-300 group h-full">
                                            <div className="w-14 h-14 bg-gradient-to-br from-amber-500 to-yellow-400 rounded-lg flex items-center justify-center mb-8 shadow-lg group-hover:scale-110 transition-transform">
                                ...
                                {infographic.entryRequirements && (
                                    <FadeIn direction="left" delay={0.2}>
                                        <div className="bg-white/[0.06] p-10 rounded-xl border border-white/[0.08] backdrop-blur-2xl hover:bg-white/[0.1] transition-colors duration-300 group h-full">
                                            <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-lg flex items-center justify-center mb-8 shadow-lg group-hover:scale-110 transition-transform">
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Partner Universities in {country.name}</h2>
                        </div>
                    </FadeIn>
                    <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                        {country.universities.map((uni) => (
                            <StaggerItem key={uni.id}>
                                <a href={uni.website || "#"} target="_blank" rel="noopener noreferrer" className="block bg-white border border-gray-100/60 rounded-xl overflow-hidden shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.1)] hover:-translate-y-1 transition-all duration-300 group h-full">
                                    <div className="relative h-56 overflow-hidden">
                                        ...
                                        <img 
                                            src={uni.imageUrl || `https://ui-avatars.com/api/?name=${encodeURIComponent(uni.name)}&background=f8fafc&color=0f172a&size=800&font-size=0.35&bold=true`} 
                                            alt={uni.name} 
                                        ...
                                        <div className="absolute bottom-4 right-4 w-10 h-10 bg-white/95 backdrop-blur-md rounded-md flex items-center justify-center shadow-lg z-20 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-300">
                    ...
                    <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8">
                        <FadeIn direction="up">
                            <div className="text-center mb-16">
                                ...
                                <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Available Courses in {country.name}</h2>
                            ...
                            {allCourses.map((course) => {
                                ...
                                return (
                                    <StaggerItem key={course.id}>
                                        <div className="bg-white border border-gray-100/60 rounded-xl p-8 shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 group h-full flex flex-col relative overflow-hidden">
                                            ...
                                            <div className="flex items-center flex-wrap gap-y-3 gap-x-4 pt-3 border-t border-gray-50 mt-auto">
                    ...
                    <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
                        <FadeIn direction="up">
                            <div className="text-center mb-16">
                                ...
                                <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">English Language Requirements</h2>
                            </div>
                        </FadeIn>
                        <FadeIn direction="up" delay={0.2}>
                            <div className="bg-white rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.06)] border border-gray-100/60 overflow-hidden">
                    ...
                    <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                        <FadeIn direction="up">
                            <div className="text-center mb-16">
                                ...
                                <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Scholarships in {country.name}</h2>
                            </div>
                        </FadeIn>
                        <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            {allScholarships.map((s) => (
                                <StaggerItem key={s.id} className="bg-white border border-gray-100/60 rounded-xl p-8 shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:-translate-y-1 hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] transition-all duration-300 group h-full relative overflow-hidden">
                                    ...
                                    <div className="w-14 h-14 bg-gradient-to-br from-amber-500 to-yellow-400 rounded-lg flex items-center justify-center mb-6 shadow-lg group-hover:scale-110 transition-transform">
                                        <Award className="w-7 h-7 text-white" />
                                    </div>
                                    <h3 className="font-bold text-[#0A1628] text-xl mb-3 leading-tight">{s.name}</h3>
                                    <div className="inline-block px-4 py-2 bg-gradient-to-r from-amber-500 to-amber-400 rounded-md text-white font-extrabold text-sm mb-4 shadow-md">
                                        {s.amount}
                                    </div>
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Visa Requirements</h2>
                        </div>
                    </FadeIn>
                    <FadeIn direction="up" delay={0.2}>
                        <div className="bg-white border border-gray-100/60 rounded-xl p-10 md:p-14 shadow-[0_20px_60px_rgba(0,0,0,0.06)] relative overflow-hidden group">
                            ...
                            <div className="relative z-10">
                                <div className="w-14 h-14 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-lg flex items-center justify-center mb-8 shadow-lg">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">FAQ about {country.name}</h2>
                        </div>
                    </FadeIn>
                    <div className="space-y-4">
                        {(faqs.length > 0 ? faqs : [
                            ...
                            <FadeIn key={i} direction="up" delay={i * 0.1}>
                                <details className="group bg-white border border-gray-100/60 rounded-lg shadow-[0_2px_16px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-all duration-300 overflow-hidden">
                                    <summary className="flex items-center justify-between p-6 cursor-pointer list-none [&::-webkit-details-marker]:hidden">
                                        ...
                                        <div className="w-10 h-10 rounded-md bg-gray-50 flex items-center justify-center shrink-0 group-open:bg-gradient-to-br group-open:from-amber-500 group-open:to-amber-400 group-open:text-white transition-colors duration-300">
