                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid lg:grid-cols-2 gap-20 items-center">
                        <FadeIn direction="right">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">From Vision to Reality</h2>
                        ...
                        <StaggerContainer className="grid grid-cols-2 gap-6">
                            {[
                                ...
                                <StaggerItem key={s.label} className="bg-white border border-gray-100/60 rounded-xl p-8 text-center shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 group">
                                    <div className={`w-14 h-14 bg-gradient-to-br ${s.gradient} rounded-lg flex items-center justify-center mx-auto mb-5 shadow-lg group-hover:scale-110 transition-transform`}>
                                        <s.icon className="w-7 h-7 text-white" />
                                    </div>
                                    <p className="text-3xl font-extrabold text-[#0A1628] mb-2">{s.value}</p>
            ...
            <section className="py-28 bg-gradient-to-b from-[var(--off-white)] to-white relative">
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Our Foundation</h2>
                    </div>
                    <StaggerContainer className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {[
                            ...
                            <StaggerItem key={item.title}>
                                <div className="bg-white border border-gray-100/60 rounded-xl p-10 text-center shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 group h-full">
                                    <div className={`w-16 h-16 bg-gradient-to-br ${item.gradient} rounded-lg flex items-center justify-center mx-auto mb-8 shadow-lg group-hover:scale-110 transition-transform`}>
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Certified Counselors</h2>
                    ...
                    <StaggerContainer className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {(counselors.length > 0 ? counselors : [
                            ...
                            <StaggerItem key={c.name}>
                                <div className="bg-white border border-gray-100/60 rounded-xl p-7 group shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 h-full flex flex-col text-center">
                                    <div className="w-16 h-16 rounded-lg bg-gradient-to-br from-amber-500 to-orange-400 flex items-center justify-center shadow-lg mx-auto mb-5 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-20">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-white tracking-tight">Our Journey</h2>
                        </div>
                    </FadeIn>
                            ...
                            <FadeIn key={item.year} direction="up" delay={i * 0.1}>
                                <div className="flex gap-6 md:gap-10 items-start group py-6">
                                    <div className="w-20 md:w-24 flex-shrink-0 text-right pt-0.5">
                                        <span className="text-lg md:text-xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-amber-400 to-yellow-300">{item.year}</span>
                                    </div>
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Certifications & Partnerships</h2>
                        </div>
                    </FadeIn>
                    <StaggerContainer className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {[
                            ...
                            <StaggerItem key={item.name}>
                                <div className="flex flex-col items-center gap-5 p-8 bg-white border border-gray-100/60 rounded-xl shadow-[0_2px_16px_rgba(0,0,0,0.04)] hover:shadow-[0_20px_60px_rgba(0,0,0,0.08)] hover:-translate-y-1 transition-all duration-300 group">
                                    <div className={`w-16 h-16 bg-gradient-to-br ${item.gradient} rounded-lg flex items-center justify-center shadow-lg group-hover:scale-110 transition-transform`}>
                                        <item.icon className="w-8 h-8 text-white" />
                                    </div>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Why Choose Cambry?</h2>
                        </div>
                    </FadeIn>
                    <StaggerContainer className="grid grid-cols-1 md:grid-cols-2 gap-5">
                        {[
                            ...
                            <StaggerItem key={item}>
                                <div className="flex items-center gap-5 p-5 bg-white border border-gray-100/60 rounded-lg shadow-[0_2px_16px_rgba(0,0,0,0.03)] hover:shadow-[0_8px_30px_rgba(0,0,0,0.06)] transition-all duration-300 group">
                                    <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-400 rounded-md flex items-center justify-center group-hover:scale-110 transition-transform shadow-md flex-shrink-0">
                ...
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Questions About Us</h2>
                        </div>
                    </FadeIn>
