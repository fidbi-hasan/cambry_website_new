                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="grid lg:grid-cols-5 gap-16">
                        ...
                        <FadeIn direction="right" className="lg:col-span-3">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] mb-4 tracking-tight">Book Your Free Consultation</h2>
                            <p className="text-gray-500 mb-10 text-lg">Fill out the form and our counselor will contact you within 24 hours.</p>
                            <div className="bg-white border border-gray-100/60 rounded-xl p-8 md:p-10 shadow-[0_20px_60px_rgba(0,0,0,0.06)] relative overflow-hidden">
                        ...
                        <FadeIn direction="left" delay={0.2} className="lg:col-span-2 space-y-6">
                            <div>
                                ...
                                <div className="space-y-4">
                                    {[
                                        ...
                                        <div key={item.title} className="flex items-start gap-4 p-5 bg-white border border-gray-100/60 rounded-lg shadow-[0_2px_16px_rgba(0,0,0,0.03)] hover:shadow-[0_12px_40px_rgba(0,0,0,0.08)] hover:-translate-y-0.5 transition-all duration-300 group">
                                            <div className={`w-12 h-12 bg-gradient-to-br ${item.gradient} rounded-md flex items-center justify-center flex-shrink-0 shadow-lg group-hover:scale-110 transition-transform`}>
                            ...
                            {/* Office Hours */}
                            <div className="p-8 bg-[#0A1628] rounded-xl shadow-[0_20px_60px_rgba(10,22,40,0.3)] relative overflow-hidden group">
                                ...
                                <div className="flex items-center gap-4 mb-6 relative z-10">
                                    <div className="w-12 h-12 bg-white/[0.06] border border-white/[0.08] rounded-md flex items-center justify-center backdrop-blur-md">
                                ...
                                <div className="space-y-4 relative z-10">
                                    <div className="flex justify-between items-center text-gray-400 border-b border-white/[0.06] pb-4">
                                        ...
                                        <span className="font-bold text-white bg-white/[0.06] px-3 py-1.5 rounded-md text-sm">10:00 AM – 7:00 PM</span>
                                    </div>
                                    <div className="flex justify-between items-center text-gray-400">
                                        <span className="font-medium">Friday</span>
                                        <span className="font-bold text-red-400 bg-red-400/10 px-3 py-1.5 rounded-md text-sm">Closed</span>
                                    </div>
                                </div>
                            </div>
                        </FadeIn>
                ...
                <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <FadeIn direction="up">
                        <div className="text-center mb-16">
                            ...
                            <h2 className="text-3xl sm:text-3xl font-extrabold text-[#0A1628] tracking-tight">Visit Our Office</h2>
                            <p className="text-gray-500 mt-4 text-lg">We&apos;re located in the heart of Dhaka</p>
                        </div>
                    </FadeIn>
                    <FadeIn direction="up" delay={0.2}>
                        <div className="bg-white border border-gray-100/60 rounded-xl h-96 flex items-center justify-center shadow-[0_20px_60px_rgba(0,0,0,0.06)] group hover:shadow-[0_30px_80px_rgba(0,0,0,0.1)] transition-all duration-500 relative overflow-hidden">
                            <div className="absolute inset-0 bg-gradient-to-br from-blue-50/30 to-amber-50/20" />
                                <div className="text-center relative z-10 p-10 bg-white/95 backdrop-blur-md border border-gray-100/60 rounded-xl shadow-[0_20px_60px_rgba(0,0,0,0.06)] transform group-hover:-translate-y-1 transition-transform duration-500">
                                <div className="w-16 h-16 bg-gradient-to-br from-blue-500 to-cyan-400 rounded-lg flex items-center justify-center mx-auto mb-6 shadow-lg group-hover:scale-110 transition-transform">
                                ...
                                <a
                                    ...
                                    className="inline-flex items-center gap-2 px-6 py-3 bg-[#0A1628] text-white rounded-md font-bold text-sm hover:bg-[#0A1628]/90 transition-all duration-300 shadow-md hover:shadow-[0_8px_30px_rgba(10,22,40,0.3)] group/btn"
                                >
                                    Open in Google Maps
