    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                {filtered.map((lead) => (
                    ...
                    >
                        ...
                        <div className="mb-4 grid grid-cols-1 sm:grid-cols-2 gap-2 text-xs">
                            <div className="px-3 py-2 rounded-md bg-blue-50 text-blue-700 font-semibold">
                                Test: {lead.testPreference || "Not provided"}
                            </div>
                            <div className="px-3 py-2 rounded-md bg-purple-50 text-purple-700 font-semibold">
                ...
                {filtered.length === 0 && (
                    <div className="col-span-2 text-center py-12 text-gray-400 bg-white rounded-lg border border-gray-100">
