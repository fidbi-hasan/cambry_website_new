            ...
            >
                    ...
                    {navItems.map((item) => {
                        ...
                        return (
                            <Link
                                ...
                                href={item.href}
                                onClick={() => setSidebarOpen(false)}
                                className={`flex items-center gap-3 px-4 py-2.5 rounded-sm transition-all duration-150 text-sm ${isActive
                ...
                <div className="p-4 border-t border-white/10">
                    <button
                        ...
                        className="flex items-center gap-3 px-4 py-2.5 rounded-sm text-gray-300 hover:bg-red-500/20 hover:text-red-400 transition-all w-full text-sm"
                    >
