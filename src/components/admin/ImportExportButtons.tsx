    ...
    return (
        <div className="flex items-center gap-2">
            ...
            <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-sm text-sm font-medium hover:bg-gray-50 hover:border-blue-300 transition-colors shadow-sm disabled:opacity-50"
            >
            ...
            <button
                ...
                className="flex items-center gap-2 px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-sm text-sm font-medium hover:bg-gray-50 hover:border-green-300 transition-colors shadow-sm"
            >
