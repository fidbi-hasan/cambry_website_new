...
export default function PageHero({
    ...
    return (
        <section className="relative min-h-[85vh] flex items-center justify-center pt-24 pb-28 bg-[#0A1628] overflow-hidden">
            ...
            <div className="relative max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 text-center z-10 w-full mt-10">
                <FadeIn direction="up">
                    ...
                    <p className="text-blue-100/60 mt-8 max-w-3xl mx-auto text-lg md:text-xl leading-relaxed font-light">
                        {subtitle}
                    </p>
                    {cta && (
                        <Link
